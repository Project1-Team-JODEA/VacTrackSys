        ...
        <div class="hero">
            <div class="form-box">
                ...
                <form id="login" class="input-group" action="Login" method="post">
                    ...
                    <button type="submit" class="submit-btn" onclick="validateLogin('login', 'MT')">Login</button>
                </form>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="width: 240px;"><input type="email" id="email" class="input-field"
                                                             placeholder="characters@characters.domain" required></td>
                            <td style="width: 40px;"></td>
                        </tr>

                        <tr><td style="width: 240px;"><input type="text" id="loc" class="input-field" 
                                                             placeholder="Location" required></td></tr>
                        <tr><td style="width: 240px;"><input type="password" name="upwd" class="input-field"  id="upwd"
                            ...
                            <td style="width: 40px;">
                                <i class="fas fa-eye" id="v-btn-p"></i>
                                <i id="validp" class="fas fa-check"></i></td>
                        </tr>
                        <tr><td style="width: 240px;">
                            ...
                            <td style="width: 40px;"><i class="fas fa-eye"  id="v-btn-c" ></i>
                                <i id="validc" class="fas fa-check"></i></td>
                        </tr>
                    </table> 
