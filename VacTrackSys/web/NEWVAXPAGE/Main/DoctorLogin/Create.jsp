...
<html>
    <head>
        ...
        <title>Record Entry - Patient</title>
        <link rel="stylesheet" href="vac_db.css">
    </head>
    <body>
        <div class="container">
    <div class="title">New Record Entry - Patient </div>
    <div class="content">
      <form name="CreateRecord" id="newrecord" action="/addRecords" method="post">
