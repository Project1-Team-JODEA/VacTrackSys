...
//    var es = document.getElementsByClassName("rsmethod");
            ...
            $(document).ready(() => {
                $("#userid").attr("oninvalid", "setCustomValidity('CDC ID must contain only numbers and must be at least 8 characters long.');"
                ...
                <form id="passwdreset" class="input-group"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="width: 40px;"><i class="fas fa-1-5x fa-eye" id="v-btn-c" onclick="toggleV('confpasswd', 'v-btn-c')"></i>
