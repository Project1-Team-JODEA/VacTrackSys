...
For Searching through database
        ...
        %>
            ...
            <div class="container" id="input-form">
                ...
                <div class="content">
                    <form name="dbaction" 
                          id="dbaction" action="Create Report" method="post" onsubmit="toggleList('loading-content')">
                        <div class="info">
                                ...
                                <div class="input-box" id="pat-info">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><select name="location" id="location" value="">
                                        ...
                                        <tr>
                                            <td><button id="filter">Add Filters</button></td>
                                        </tr>
                                        <tr>
                                            <td><span class="details">Doses:</span></td>
